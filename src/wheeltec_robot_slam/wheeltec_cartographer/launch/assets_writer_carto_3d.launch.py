...
def generate_launch_description():
    ...
    ## ***** Launch arguments *****
    configuration_directory_arg = DeclareLaunchArgument('configuration_directory', default_value = FindPackageShare('wheeltec_cartographer').find('wheeltec_cartographer') + '/config')
    config_file_arg = DeclareLaunchArgument('config_file', default_value = 'assets_writer_carto_3d.lua')
    
    urdf_filename_arg = DeclareLaunchArgument('urdf_filename', default_value = FindPackageShare('wheeltec_cartographer').find('wheeltec_cartographer') + '/urdf/wheeltec_3d.urdf')
