...
def generate_launch_description():
    ...
    launch_depth_scan2 = LaunchConfiguration('launch_depth_scan2')
    ...
    declare_launch_camera_cmd = DeclareLaunchArgument(
        'launch_camera', default_value='true', choices=['true', 'false'],
    ...
    declare_launch_depth_scan2_cmd = DeclareLaunchArgument(
        'launch_depth_scan2', default_value='false', choices=['true', 'false'],
        description='Launch second depth-to-laserscan converter')
    ...
    depth_to_laserscan = GroupAction([
        ...
        Node(
            ...
            output='screen'),
        Node(
            condition=IfCondition(launch_depth_scan2),
            name='depth2laser2',
            package='depthimage_to_laserscan',
            executable='depthimage_to_laserscan_node',
            parameters=[{'scan_time': 0.033,
    ...
    ld.add_action(declare_launch_depth_scan2_cmd)
