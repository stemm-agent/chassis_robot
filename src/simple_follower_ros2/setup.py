...
data_files.append(('share/' + package_name, ['launch/radar_follower.launch.py']))
data_files.append(('share/' + package_name, ['launch/radar_tracker.launch.py']))
...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'lasertracker = simple_follower_ros2.laserTracker:main',
            'arfollower = simple_follower_ros2.ar_follow:main',
            'radarfollower = simple_follower_ros2.radarfollower:main',
            'radarkeyboard = simple_follower_ros2.radarkeyboard:main',
            'radarTracker = simple_follower_ros2.radarTracker:main',
            'line_follow_model = simple_follower_ros2.line_follow_model:main'
