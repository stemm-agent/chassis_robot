...
private:
    ...
    std::string last_feedback_audio_;
    ...
    rclcpp::Subscription<std_msgs::msg::String>::SharedPtr feedback_audio_sub;
    rclcpp::Subscription<std_msgs::msg::String>::SharedPtr voice_words_sub;
    rclcpp::Subscription<std_msgs::msg::UInt64>::SharedPtr wake_feedback_request_sub_;
    rclcpp::Publisher<std_msgs::msg::UInt64>::SharedPtr wake_feedback_done_pub_;

    void feedback_audio_Callback(const std_msgs::msg::String::SharedPtr msg);
    ...
    void wake_feedback_request_Callback(const std_msgs::msg::UInt64::SharedPtr msg);
